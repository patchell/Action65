...
bool CAct65ROR::Create(CAstNode* pChild, CAstNode* pNext, CBin* pSym, CSection* pSec)
{
	bool rV = true;
...
CValue* CAct65ROR::Process(SAuxEmitInfo* pAuxInfo)
{
...
CValue* CAct65ROR::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
