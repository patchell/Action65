...
bool CAct65W65C816::Create(CAstNode* pChild, CAstNode* pNext, CBin* pSym, CSection* pSec)
{
	bool rV = true;
...
CValue* CAct65W65C816::Process(SAuxEmitInfo* pAuxInfo)
{
...
CValue* CAct65W65C816::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
