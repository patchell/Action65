...
CValue* CAct65VarParameter::Process()
{
...
int CAct65VarParameter::Print(int Indent, char* s, int Strlen, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65VarParameter::Emit(CValue* pVc, CValue* pVn)
{
	return nullptr;
}
