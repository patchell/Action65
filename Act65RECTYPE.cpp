...
bool CAct65RECTYPE::Create(CAstNode* pChild, CAstNode* pNext, CBin* pSym, CSection* pSec)
{
	bool rV = true;
...
CValue* CAct65RECTYPE::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65RECTYPE::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65RECTYPE::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
	return nullptr;
}
