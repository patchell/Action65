...
CValue* CAct65TRUE::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65TRUE::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65TRUE::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
