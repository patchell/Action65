...
bool CAct65FlagCARRY::Create(CAstNode* pChild, CAstNode* pNext, CBin* pSym, CSection* pSec)
{
	bool rV = true;
...
CValue* CAct65FlagCARRY::Process(SAuxEmitInfo* pAuxInfo)
{
...
CValue* CAct65FlagCARRY::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
