...
CValue* CAct65ASMstatement::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65ASMstatement::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65ASMstatement::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
