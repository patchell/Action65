...
bool CAct65CONSTANT::Create(CAstNode* pChild, CAstNode* pNext, CBin* pSym, CSection* pSec)
{
	bool rV = true;
...
CValue* CAct65CONSTANT::Process(SAuxEmitInfo* pAuxInfo)
{
...
CValue* CAct65CONSTANT::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
