...
CValue* CAct65LowerPart::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65LowerPart::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65LowerPart::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
	return nullptr;
}
