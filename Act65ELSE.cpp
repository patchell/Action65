...
CValue* CAct65ELSE::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65ELSE::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65ELSE::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
