...
CValue* CAct65AssignXOR::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65AssignXOR::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65AssignXOR::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
