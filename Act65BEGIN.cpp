...
CValue* CAct65BEGIN::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65BEGIN::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65BEGIN::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
