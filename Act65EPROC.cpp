...
CValue* CAct65EPROC::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65EPROC::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65EPROC::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
