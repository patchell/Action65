...
bool CAct65FlagOVERFLOW::Create(CAstNode* pChild, CAstNode* pNext, CBin* pSym, CSection* pSec)
{
	bool rV = true;
...
CValue* CAct65FlagOVERFLOW::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65FlagOVERFLOW::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65FlagOVERFLOW::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
	return nullptr;
}
