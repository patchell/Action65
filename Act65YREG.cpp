...
bool CAct65YREG::Create(CAstNode* pChild, CAstNode* pNext, CBin* pSym, CSection* pSec)
{
	bool rV = true;
...
CValue* CAct65YREG::Process(SAuxEmitInfo* pAuxInfo)
{
...
CValue* CAct65YREG::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
	return nullptr;
}
