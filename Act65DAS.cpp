...
CValue* CAct65DAS::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65DAS::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65DAS::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
