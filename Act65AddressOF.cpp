...
CValue* CAct65AddressOF::Process(SAuxEmitInfo* pAuxInfo)
{
...
int CAct65AddressOF::Print(char* s, int Strlen, int Indent, const char* pAuxStr, bool* pbNextFlag)
{
	int l = 0;
...
CValue* CAct65AddressOF::Emit(CValue* pVc, CValue* pVn, SAuxEmitInfo* pAuxInfo)
{
    return nullptr;
}
